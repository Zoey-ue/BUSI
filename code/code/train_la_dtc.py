...
from networks.dataloaders.la_heart import LAHeart, RandomCropResize, CenterCrop, RandomRotFlip, ToTensor, TwoStreamBatchSampler, Resize
from utils.util import compute_sdf
from config import Config as configs   # 对应位置导入配置文件

from torchsummary import summary

model_name = 'Vnet_Aug'   # ☆☆☆☆☆  Vnet、Vnet_Aug
...
parser.add_argument('--base_lr', type=float, default=0.005,  # gxz
...
snapshot_path = "./train/" + model_name + "_{}_{}_{}/".format(args.beta, args.batch_size, args.labeled_bs)
...
def create_model(ema=False):
    # 定义模型网络结构
    net = VNet(n_channels=3, n_classes=num_classes, normalization='batchnorm', has_dropout=True)
    # 将模型加载至cuda
